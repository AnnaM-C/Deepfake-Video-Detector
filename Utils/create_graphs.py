...
def plot_individual_graphs(logdir1,logdir2,logdir3a, logdir3b):
    ...
    # # Lists to hold epoch numbers and accuracies
    # epochs = []
    # accuracies = []

    # for file in os.listdir(logdir1):
    #     if file.startswith("events.out.tfevents"):
    #         filepath = os.path.join(logdir1, file)
    #         for e in tf.compat.v1.train.summary_iterator(filepath):
    #             for v in e.summary.value:
    #                 if v.tag == 'Accuracy/train':
    #                     epochs.append(e.step)
    #                     accuracies.append(v.simple_value)
    #                     print("Epoch:", e.step, "Accuracy:", v.simple_value)
    ...
    # plt.legend()
    # plt.grid(True)
    # plt.savefig("/vol/research/DeepFakeDet/rPPG-Toolbox/results_0/graphs/PhysNet_16frames_Accuracy.png")
...
# for file in os.listdir(logdir_16_frames_1):
#     if file.startswith("events.out.tfevents"):
#         filepath = os.path.join(logdir_16_frames_1, file)
#         for e in tf.compat.v1.train.summary_iterator(filepath):
#             for v in e.summary.value:
#                 if v.tag == 'Accuracy/train':
#                     epochs.append(e.step)
...
# for file in os.listdir(logdir_16_frames_2):
#     if file.startswith("events.out.tfevents"):
#         filepath = os.path.join(logdir_16_frames_2, file)
#         for e in tf.compat.v1.train.summary_iterator(filepath):
#             for v in e.summary.value:
#                 if v.tag == 'Accuracy/train':
#                     adjusted_epoch = e.step + last_epoch +1
#                     epochs.append(adjusted_epoch)
#                     accuracies.append(v.simple_value)
#                     print("Epoch:", adjusted_epoch, "Accuracy:", v.simple_value)
...
# def plot_graphs_and_join_epochs(logdir_16_frames_1, logdir_16_frames_2, logdir_32_frames_1, logdir_32_frames_2):
#     train_accuracies_32, valid_accuracies_32, train_loss_32, valid_loss_32 = [], [], [], []
#     train_accuracies_16, valid_accuracies_16, train_loss_16, valid_loss_16 = [], [], [], []

#     training_accuracies_epochs_list_16, validation_accuracies_epochs_list_16, training_loss_epochs_list_16, validation_loss_epochs_list_16 = [], [], [], []
#     training_accuracies_epochs_list_32, validation_accuracies_epochs_list_32, training_loss_epochs_list_32, validation_loss_epochs_list_32 = [], [], [], []
...
#     # process the 16 frame directories
#     process_directory(logdir_16_frames_1, training_accuracies_epochs_list_16, validation_accuracies_epochs_list_16, training_loss_epochs_list_16, validation_loss_epochs_list_16, train_accuracies_16, valid_accuracies_16, train_loss_16, valid_loss_16)
#     last_epoch_16 = max(training_accuracies_epochs_list_16) if training_accuracies_epochs_list_16 else 0
#     process_directory(logdir_16_frames_2, training_accuracies_epochs_list_16, validation_accuracies_epochs_list_16, training_loss_epochs_list_16, validation_loss_epochs_list_16, train_accuracies_16, valid_accuracies_16, train_loss_16, valid_loss_16, initial_epoch=last_epoch_16 + 1)

#     # process the 32 frame directories
#     process_directory(logdir_32_frames_1, training_accuracies_epochs_list_32, validation_accuracies_epochs_list_32, training_loss_epochs_list_32, validation_loss_epochs_list_32, train_accuracies_32, valid_accuracies_32, train_loss_32, valid_loss_32)
#     last_epoch_32 = max(training_accuracies_epochs_list_32) if training_accuracies_epochs_list_32 else 0
#     process_directory(logdir_32_frames_2, training_accuracies_epochs_list_32, validation_accuracies_epochs_list_32, training_loss_epochs_list_32, validation_loss_epochs_list_32, train_accuracies_32, valid_accuracies_32, train_loss_32, valid_loss_32, initial_epoch=last_epoch_32 + 1)

#     # plot training accuracy
#     plt.figure(figsize=[8,6])
#     plt.plot(training_accuracies_epochs_list_16, train_accuracies_16, label='16 Frames')
#     plt.plot(training_accuracies_epochs_list_32, train_accuracies_32, label='32 Frames')
#     plt.xlabel('Epochs', fontsize=14)
#     plt.ylabel('Accuracy', fontsize=14)
#     # plt.title('Training Accuracy over Epochs for 16 and 32 Frames')
#     plt.legend(fontsize=12)
#     plt.tick_params(axis='both', which='major', labelsize=12)
#     plt.grid(True)
#     plt.savefig("/vol/research/DeepFakeDet/rPPG-Toolbox/results_0/graphs/chunk_size_experiments/PhysNet_Training_Accuracy_chunksize.png")

#     # plot validation accuracy
#     plt.figure(figsize=[8,6])
#     plt.plot(validation_accuracies_epochs_list_16, valid_accuracies_16, label='16 Frames')
#     plt.plot(validation_accuracies_epochs_list_32, valid_accuracies_32, label='32 Frames')
#     plt.xlabel('Epochs', fontsize=14)
#     plt.ylabel('Accuracy', fontsize=14)
#     # plt.title('Validation Accuracy over Epochs for 16 and 32 Frames')
#     plt.legend(fontsize=12)
#     plt.tick_params(axis='both', which='major', labelsize=12)
#     plt.grid(True)
#     plt.savefig("/vol/research/DeepFakeDet/rPPG-Toolbox/results_0/graphs/chunk_size_experiments/PhysNet_Valid_Accuracy_chunksize.png")

#     # plot training loss
#     plt.figure(figsize=[8,6])
#     plt.plot(training_loss_epochs_list_16, train_loss_16, label='16 Frames')
#     plt.plot(training_loss_epochs_list_32, train_loss_32, label='32 Frames')
#     plt.xlabel('Epochs', fontsize=14)
#     plt.ylabel('Loss', fontsize=14)
#     # plt.title('Training Loss over Epochs for 16 and 32 Frames')
#     plt.legend(fontsize=12)
#     plt.tick_params(axis='both', which='major', labelsize=12)    
#     plt.grid(True)
#     plt.savefig("/vol/research/DeepFakeDet/rPPG-Toolbox/results_0/graphs/chunk_size_experiments/PhysNet_Training_Loss_chunksize.png")

#     # plot validation loss
#     plt.figure(figsize=[8,6])
#     plt.plot(validation_loss_epochs_list_16, valid_loss_16, label='16 Frames')
#     plt.plot(validation_loss_epochs_list_32, valid_loss_32, label='32 Frames')
#     plt.xlabel('Epochs', fontsize=14)
#     plt.ylabel('Loss', fontsize=14)
#     # plt.title('Validation Loss over Epochs for 16 and 32 Frames')
#     plt.legend(fontsize=12)
#     plt.tick_params(axis='both', which='major', labelsize=12)
#     plt.grid(True)
#     plt.savefig("/vol/research/DeepFakeDet/rPPG-Toolbox/results_0/graphs/chunk_size_experiments/PhysNet_Validation_Loss_chunksize.png")
